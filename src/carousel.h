...
#define APP_CAROUSEL_CLASS(klass)                                                                  \
        (G_TYPE_CHECK_CLASS_CAST((klass), APP_CAROUSEL_TYPE, AppCarouselClass))
#define IS_APP_CAROUSEL_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), APP_CAROUSEL_TYPE))
#define APP_CAROUSEL_GET_CLASS(obj)                                                                \
        (G_TYPE_INSTANCE_GET_CLASS((obj), APP_CAROUSEL_TYPE, AppCarouselClass))
