...
enum { PROP_MIN, PROP_APPINFO, PROP_ACTIVE, N_PROPERTIES };

static GParamSpec *obj_props[N_PROPERTIES] = {
        NULL,
};

static void launcher_image_set_property(GObject *object, guint prop_id, const GValue *value,
                                        GParamSpec *pspec)
{
        LauncherImage *self;
...
static void launcher_image_get_property(GObject *object, guint prop_id, GValue *value,
                                        GParamSpec *pspec)
{
        LauncherImage *self;
...
static void launcher_image_class_init(LauncherImageClass *klass)
{
        ...
        obj_props[PROP_APPINFO] = g_param_spec_pointer("appinfo",
                                                       "AppInfo",
                                                       "AppInfo",
...
GtkWidget *launcher_image_new(GAppInfo *info)
{
        ...
        self = g_object_new(LAUNCHER_IMAGE_TYPE,
                            "orientation",
